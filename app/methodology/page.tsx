    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <section className="mt-10 space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-5 text-gray-700">
          <li>
            <strong>Formal ratings</strong> (authoritative) — full five-pillar assessments updated quarterly for the 17 UK institutions and their international peers.
          </li>
          <li>
      ...
      <section className="mt-10 space-y-4">
        ...
        <p className="text-gray-700 leading-relaxed">
          Each week the 17 UK institutions receive a directional signal based primarily on short-term movements in Public Trust, using:
        </p>
