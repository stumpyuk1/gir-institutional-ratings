...
export const part2: Institution[] = [

  {
    ...
    signalDriver: "Publication of the Thirlwall Inquiry report on 15 September detailed a complete failure to protect babies and dysfunctional management at the Countess of Chester Hospital in the Lucy Letby case, intensifying short-term public trust concerns over NHS safeguarding and accountability.",
...

  {
    ...
    weeklySignal: "Neutral",
    signalWeek: "13 – 19 Sep 2026",
    signalDriver: "Routine open-letter exchange on inflation; no material new institutional-standing shock.",
