...
export interface Institution {
  ...
  peers: { name: string; country: string; rating: RatingCode; outlook: Outlook }[];
}
...
export const institutions: Institution[] = [
  {
    ...
    peers: [
      { name: "House of Orange-Nassau", country: "Netherlands", rating: "AA–", outlook: "Stable" },
      { name: "House of Bernadotte", country: "Sweden", rating: "AA", outlook: "Stable" },
      { name: "House of Glücksburg", country: "Norway", rating: "AA", outlook: "Stable" },
      { name: "House of Glücksburg", country: "Denmark", rating: "AA–", outlook: "Stable" },
      { name: "House of Bourbon", country: "Spain", rating: "A", outlook: "Stable" },
      { name: "House of Saxe-Coburg and Gotha", country: "Belgium", rating: "A+", outlook: "Stable" }
    ]
  },
  {
    id: "2",
    ...
    peers: [
      { name: "Bundestag / Bundesrat", country: "Germany", rating: "AA–", outlook: "Stable" },
      { name: "National Assembly / Senate", country: "France", rating: "A", outlook: "Stable" },
      { name: "Parliament of Canada", country: "Canada", rating: "A+", outlook: "Stable" },
      { name: "Parliament of Australia", country: "Australia", rating: "A+", outlook: "Stable" },
      { name: "States General", country: "Netherlands", rating: "AA–", outlook: "Stable" },
      { name: "Riksdag", country: "Sweden", rating: "AA", outlook: "Stable" }
    ]
  },
  {
    id: "3",
    ...
    peers: [
      { name: "Federal Civil Service", country: "Germany", rating: "AA–", outlook: "Stable" },
      { name: "Fonction publique", country: "France", rating: "A", outlook: "Stable" },
      { name: "Public Service of Canada", country: "Canada", rating: "A+", outlook: "Stable" },
      { name: "Australian Public Service", country: "Australia", rating: "A+", outlook: "Stable" },
      { name: "Dutch civil service", country: "Netherlands", rating: "AA–", outlook: "Stable" },
      { name: "Singapore Civil Service", country: "Singapore", rating: "AA", outlook: "Stable" }
    ]
  },
  {
    id: "4",
    ...
    peers: [
      { name: "Federal Courts / FCC", country: "Germany", rating: "AA", outlook: "Stable" },
      { name: "Conseil d’État / Cour de cassation", country: "France", rating: "A+", outlook: "Stable" },
      { name: "Federal & provincial courts", country: "Canada", rating: "AA–", outlook: "Stable" },
      { name: "Federal & state courts", country: "Australia", rating: "AA–", outlook: "Stable" },
      { name: "Dutch judiciary", country: "Netherlands", rating: "AA–", outlook: "Stable" },
      { name: "US federal judiciary", country: "United States", rating: "A", outlook: "Negative" }
    ]
  },
  {
    id: "5",
    ...
    peers: [
      { name: "French Armed Forces", country: "France", rating: "AA–", outlook: "Stable" },
      { name: "Bundeswehr", country: "Germany", rating: "A+", outlook: "Positive" },
      { name: "Australian Defence Force", country: "Australia", rating: "AA–", outlook: "Stable" },
      { name: "Canadian Armed Forces", country: "Canada", rating: "A+", outlook: "Stable" },
      { name: "Royal Netherlands Armed Forces", country: "Netherlands", rating: "A+", outlook: "Stable" },
      { name: "Swedish Armed Forces", country: "Sweden", rating: "A+", outlook: "Positive" }
    ]
  },
  {
    id: "6",
    ...
    peers: [
      { name: "State police / BKA", country: "Germany", rating: "A+", outlook: "Stable" },
      { name: "National Police + Gendarmerie", country: "France", rating: "A", outlook: "Stable" },
      { name: "National Police", country: "Netherlands", rating: "A+", outlook: "Stable" },
      { name: "RCMP + provincial forces", country: "Canada", rating: "A", outlook: "Stable" },
      { name: "State & federal police", country: "Australia", rating: "A+", outlook: "Stable" },
      { name: "Swedish Police Authority", country: "Sweden", rating: "A", outlook: "Stable" }
    ]
  },
  {
    id: "7",
    ...
    peers: [
      { name: "French healthcare system", country: "France", rating: "A", outlook: "Stable" },
      { name: "German GKV system", country: "Germany", rating: "A+", outlook: "Stable" },
      { name: "Nordic universal systems", country: "Sweden / Nordic", rating: "AA–", outlook: "Stable" },
      { name: "Canadian Medicare", country: "Canada", rating: "A–", outlook: "Negative" },
      { name: "Australian Medicare + public hospitals", country: "Australia", rating: "A", outlook: "Stable" },
      { name: "Dutch regulated competition system", country: "Netherlands", rating: "A+", outlook: "Stable" }
    ]
  },
  {
    id: "8",
    ...
    peers: [
      { name: "German university system", country: "Germany", rating: "A+", outlook: "Stable" },
      { name: "French universities + grandes écoles", country: "France", rating: "A", outlook: "Stable" },
      { name: "Australian university system", country: "Australia", rating: "A+", outlook: "Negative" },
      { name: "Canadian university system", country: "Canada", rating: "A+", outlook: "Stable" },
      { name: "Dutch universities", country: "Netherlands", rating: "AA–", outlook: "Stable" },
      { name: "Nordic university systems", country: "Sweden / Denmark", rating: "AA–", outlook: "Stable" }
    ]
  },
  {
    id: "9",
    ...
    peers: [
      { name: "ARD / ZDF", country: "Germany", rating: "AA–", outlook: "Stable" },
      { name: "France Télévisions / Radio France", country: "France", rating: "A", outlook: "Stable" },
      { name: "CBC / Radio-Canada", country: "Canada", rating: "A", outlook: "Stable" },
      { name: "ABC / SBS", country: "Australia", rating: "A+", outlook: "Stable" },
      { name: "NHK", country: "Japan", rating: "AA–", outlook: "Stable" },
      { name: "Nordic public broadcasters", country: "Nordic", rating: "AA–", outlook: "Stable" }
    ]
  },
  {
    id: "10",
    ...
    peers: [
      { name: "Federal Reserve", country: "United States", rating: "AA–", outlook: "Stable" },
      { name: "European Central Bank", country: "Euro area", rating: "AA–", outlook: "Stable" },
      { name: "Bank of Canada", country: "Canada", rating: "AA–", outlook: "Stable" },
      { name: "Reserve Bank of Australia", country: "Australia", rating: "A+", outlook: "Stable" },
      { name: "Sveriges Riksbank", country: "Sweden", rating: "AA–", outlook: "Stable" },
      { name: "Swiss National Bank", country: "Switzerland", rating: "AA", outlook: "Stable" }
    ]
  },
  {
    id: "11",
    ...
    peers: [
      { name: "Federal Ministry of Finance", country: "Germany", rating: "AA", outlook: "Stable" },
      { name: "Ministry of Economy and Finance", country: "France", rating: "A", outlook: "Negative" },
      { name: "US Department of the Treasury", country: "United States", rating: "AA–", outlook: "Stable" },
      { name: "Department of Finance", country: "Canada", rating: "AA–", outlook: "Stable" },
      { name: "Australian Treasury", country: "Australia", rating: "AA–", outlook: "Stable" },
      { name: "Ministry of Finance", country: "Netherlands", rating: "AA", outlook: "Stable" }
    ]
  },
  {
    id: "12",
    ...
    peers: [
      { name: "Municipalities and Länder", country: "Germany", rating: "A+", outlook: "Stable" },
      { name: "Collectivités territoriales", country: "France", rating: "A", outlook: "Stable" },
      { name: "Municipalities and provinces", country: "Netherlands", rating: "A+", outlook: "Stable" },
      { name: "Kommuner and regions", country: "Sweden", rating: "AA–", outlook: "Stable" },
      { name: "Municipalities and provinces", country: "Canada", rating: "A", outlook: "Stable" },
      { name: "Local + state governments", country: "Australia", rating: "A", outlook: "Stable" }
    ]
  },
  {
    id: "13",
    ...
    peers: [
      { name: "Church of Sweden", country: "Sweden", rating: "BBB+", outlook: "Negative" },
      { name: "Church of Norway", country: "Norway", rating: "BBB+", outlook: "Negative" },
      { name: "Church of Denmark", country: "Denmark", rating: "BBB+", outlook: "Negative" },
      { name: "Evangelical Church in Germany (EKD)", country: "Germany", rating: "BBB", outlook: "Negative" },
      { name: "Church of Scotland", country: "Scotland", rating: "BB+", outlook: "Negative" },
      { name: "Other Nordic established churches", country: "Nordic", rating: "BBB", outlook: "Negative" }
    ]
  }
];
